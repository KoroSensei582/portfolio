...
hero:
  src: "./imu-board.jpg"
  alt: "Inertial measurement unit breakout board, top view"
---
...
- Six-axis MEMS IMU (accelerometer + gyroscope) with an I²C interface — [specific part number]
- Two-layer board, [dimensions]
