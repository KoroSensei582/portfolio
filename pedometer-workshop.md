...
hero:
  src: "./pedometer-workshop.jpg"
  alt: "Assembled pedometer boards on a workbench"
---
...
- [Accelerometer — e.g., LIS3DH or ADXL345] over I²C
- [Microcontroller — e.g., ATmega328P] chosen for student accessibility and a readable datasheet
- [Power: coin cell or similar] with basic reverse-polarity protection
